...
| <a name="module_logs"></a> [logs](#module\_logs) | cloudposse/s3-log-storage/aws | 2.0.0 |
...
| <a name="input_connection_function_id"></a> [connection\_function\_id](#input\_connection\_function\_id) | ID of a CloudFront connection function to associate with the distribution. The connection function (`aws_cloudfront_connection_function`) should be managed outside this module. | `string` | `null` | no |
