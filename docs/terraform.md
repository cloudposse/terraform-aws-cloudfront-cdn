...
| <a name="input_grpc_config"></a> [grpc\_config](#input\_grpc\_config) | The gRPC configuration for the default CloudFront distribution cache behavior | <pre>object({<br/>    enabled = bool<br/>  })</pre> | `null` | no |
