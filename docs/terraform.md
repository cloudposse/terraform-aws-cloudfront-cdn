...
| <a name="input_s3_origin_config"></a> [s3\_origin\_config](#input\_s3\_origin\_config) | Configuration for S3 origin. Required when origin\_type is 's3'. | <pre>object({<br/>    origin_access_identity = string<br/>  })</pre> | `null` | no |
