...
module "logs" {
  source                   = "git::https://github.com/cloudposse/terraform-aws-log-storage.git?ref=tags/0.12.0"
  namespace                = var.namespace
  stage                    = var.stage
  name                     = var.name
  delimiter                = var.delimiter
...
module "dns" {
  source           = "git::https://github.com/cloudposse/terraform-aws-route53-alias.git?ref=tags/0.6.0"
